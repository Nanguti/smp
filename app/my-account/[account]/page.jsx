                  ...
                  >
                    ...
                    >
                      <div className="myaccount-dashboard">
                        <p>
                          Hello <b>Nanguti Wanyonyi</b> (not Edwin Adams?{" "}
                          <a href="#">Sign out</a>)
                        </p>
                        <p>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a
                                    href="#"
                                    className="uren-btn uren-btn_dark uren-btn_sm"
                                  >
                                    <span>View</span>
                                  </a>
                                </td>
                      ...
                      <div className="myaccount-address">
                        ...
                        <div className="row">
                          <div className="col">
                            ...
                            <address>
                              1234 Heaven Stress, Beverly Hill OldYork
                      ...
                      <div className="myaccount-details">
                        <form action="#" className="uren-form">
                          <div className="uren-form-inner">
                            ...
                            <div className="single-input">
                              <button
                                className="uren-btn uren-btn_dark"
                                type="submit"
                              >
